...
@include('dashboard.dashboardadmin')               
        <div class="col-xs-12 col-sm-3 col-md-9 col-lg-9">
                    <div class="info_dv">
                        ...
                        <div class="heads"><i class="fa fa-list">&nbsp;Companies</i>                           
                            <div class="job" style="float:right !important;">

                                <i class="fa fa-plus"><a href="{{route ('admin.admin-createcompany')}}" title="Add Company">&nbsp;Add</a></i>
                            </div>
                        </div>
    ...
    <div class="job_content" >
        ...
        <table id="jobcategorytable" class="display" style="width:100%">
            ...
            <tbody>
                ...
                <tr class="job_list">
                    <th>
                        <img src="/uploads/avatar/admin/{{$company->company_logo}}" width="24px" height="24px">
                    </th>
                    <td><a href="/company/{{ $company->id}}-{{Str::slug($company->name)}}">{{ucwords($company->name)}}</a></td>
                    <td>{{ Carbon\Carbon::parse($company->created_at)->toFormattedDateString()}}</td>
                    <td>
                        <a class="label label-primary" title="Edit" href="{{route('admin.admin-editcompany', $company->id)}}" role="button">EDIT</a>&nbsp;
                        <a href="{{url("admin/company/delete/{$company->id}")}}" title="Delete" class="label label-danger" onclick="return confirm('Are you sure you want to delete this item?');">DELETE</a>  
                    </td>
                </tr>
        @endforeach
        </form>
