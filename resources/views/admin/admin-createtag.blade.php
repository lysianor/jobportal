...
<div class="col-lg-9">
                        ...
                        <div class="info_dv">
                            <div class="heads">Create Tag</div>
...
{{--                @if(session('success'))
                ...
                <div class="form_lst">
                    ...
                    <span class="rltv">
                        <input id="tag" type="text" maxlength="50" placeholder="Tag" class="form-control  @error('tag') is-invalid @enderror" name="tag"  required autocomplete="tag">
                            @error('tag')
