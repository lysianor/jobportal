...
<div class="col-lg-9">
                        ...
                        <div class="info_dv">
                            <div class="heads">Create Job Category</div>
...
{{--                @if(session('success'))
                ...
                <div class="form_lst">
                    ...
                    <span class="rltv">
                        <input id="jobcategory" type="text" maxlength="50" placeholder="Job Category" class="form-control  @error('jobcategory') is-invalid @enderror" name="jobcategory"  required autocomplete="category">
                            @error('jobcategory')
