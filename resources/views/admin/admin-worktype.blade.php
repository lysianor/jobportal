...
@include('dashboard.dashboardadmin')               
        <div class="col-xs-12 col-sm-3 col-md-9 col-lg-9">
                    <div class="info_dv">
                        ...
                        <div class="heads"><i class="fa fa-list">&nbsp;Work Type</i>                           
                            <div class="job" style="float:right !important;">

                                <i class="fa fa-plus"><a href="{{route ('admin.admin-createworktype')}}" title="Add Work Type">&nbsp;Add</a></i>
                            </div>
                        </div>
        ...
        <table id="jobcategorytable" class="display" style="width:100%">
            ...
            <tbody>
                ...
                <tr class="job_list">
                    ...
                    <td>
                        <a class="label label-primary" title="Edit" href="{{route('admin.admin-editworktype', $row->id)}}" role="button">EDIT</a>&nbsp;
                        <a href="{{url("admin/work-type/delete/{$row->id}")}}" title="Delete" class="label label-danger" onclick="return confirm('Are you sure you want to delete this item?');">DELETE</a>  
                    </td>
                </tr>
        @endforeach
        </form>
