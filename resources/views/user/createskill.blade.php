...
<div class="col-xs-12 col-sm-6 col-md-9 col-lg-9">
                    ...
                    <div class="info_dv info_dv_esdit_pre">
                        <div class="heads"><i class="fa fa-vine">&nbsp;Skill</i></div>  
                    ...
                    <div class="form_lst">
                        ...
                        <span class="rltv">
                            <input id="name" type="text" placeholder="Ex. Leadership, Adaptability, Communication skills etc." class="form-control required @error('name') is-invalid @enderror" name="name" required autocomplete="name">
                            @error('name')
