...
<div class="image_sec" style="background: url(/images/profile_banner.png">
    ...
    <div class="left_lnks">
        <div class="my_hd mobile_sh">Education</div>    
        <div class="my_hd profilebx"><span>Education</span></div>
...
<div class="col-xs-12 col-sm-6 col-md-9 col-lg-9">
                    ...
                    <div class="form_lst">
                        ...
                        <span class="rltv">
                            <input id="school" type="text" placeholder="Name of the Institution your are studying at/studied" class="form-control required @error('school') is-invalid @enderror" name="school" required autocomplete="school">
                            @error('school')
                   ...
                   <div class="form_lst">
                        ...
                        <div id="locDiv" class="rltv">
                            <div class="dty">
                                <select name="month" class="form-control validname @error('month') is-invalid @enderror" id="month" required autocomplete="month">
                            ...
                            <div class="dty">                        
                                <select name="year" class="form-control validname @error('year') is-invalid @enderror" id="year" required autocomplete="year">
                    ...
                    <div class="form_lst">
                        ...
                        <span class="rltv">
                            <select name="qualification" class="form-control @error('qualification') is-invalid @enderror" id="qualification" required autocomplete="qualification">
                                ...
                                <option value="Vocational Diploma / Short Course Cerficate" >Vocational Diploma / Short Course Cerficate</option>
                    ...
                    <div class="form_lst">
                        <label>Major</label>
                        <span class="rltv">
                            <input id="major" type="text" placeholder="Major" class="form-control required @error('major') is-invalid @enderror" name="major">
                            @error('major')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
